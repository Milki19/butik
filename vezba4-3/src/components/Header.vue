          ...
          <div class="nav-wrapper container-fluid text-center">
              <div class="row w-100">
                ...
                <ul class="navbar mb-lg-0">
                    ...
                    <li class="nav-item"></li><router-link to="/kategorije">Kategorije</router-link>
                    <li class="nav-item"></li><router-link to="/sviProizvodi">Proizvodi</router-link>
                    <li class="nav-item"></li><router-link to="/prijavi-promenu">Javi nam se!</router-link>
                </ul>
                </div>    
            </div>
          </div>
